...
const FilterComponent = ({
    ...
    // Hàm xử lý toggle cho categoryId (chỉ chọn 1)
                        ...
                        <View style={styles.optionsContainer}>
                            {group.childrens?.map(child => (
                                <TouchableOpacity
                                    ...
                                    style={[
                                        styles.optionButton,
                                        selectedCategoryId === child.id && styles.optionButtonSelected
                                    ]}
                                    onPress={() => toggleCategory(child.id)}
                                >
                                    <Text style={[
                                        styles.optionText,
                                        selectedCategoryId === child.id && styles.optionTextSelected
                                    ]}>
                                        {child.category_name}
                                    </Text>
                                </TouchableOpacity>
...
const styles = StyleSheet.create({
    container: {
        flex: 1,
        backgroundColor: '#f5f5f5', // Nền xám nhạt giống Shopee
    },
    scrollContent: {
        padding: 0,
        paddingBottom: 120, // Thêm paddingBottom để nội dung cuối không sát đáy
    },
    section: {
        marginBottom: 24,
        backgroundColor: '#fff', // Nền trắng cho mỗi section
        padding: 16,
        // Shadow cho Android
        elevation: 3,
        // Shadow cho iOS
    ...
    optionButton: {
        ...
        borderWidth: 1,
        borderColor: '#ddd',
        borderRadius: 3, // Bo góc tròn giống Shopee
        backgroundColor: '#fff',
    },
